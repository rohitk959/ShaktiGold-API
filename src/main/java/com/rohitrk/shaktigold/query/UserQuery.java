...
public class UserQuery {
	public static final String FETCH_USER_ACCOUNT_BY_EMAIL = "SELECT user_account.first_name, user_account.last_name, user_account.email, user_account.role, user_account.password_hash, user_account.password_salt FROM shaktigold.user_account user_account WHERE user_account.email = UPPER(?)";
	
	public static final String INSERT_SINGLE_USER = "INSERT INTO shaktigold.user_account (first_name, last_name, email, role, password_salt, password_hash, created_date) VALUES (?, ?, UPPER(?), 'USER', ?, ?, now()); ";
	...
	public static final String GET_USER_SESSION = "SELECT ssid FROM shaktigold.user_session where user_account_fk = (SELECT id FROM shaktigold.user_account WHERE email = UPPER(?))";
	...
	public static final String UPDATE_USER_PASSWORD = "UPDATE shaktigold.user_account SET password_hash = ?, password_salt = ? WHERE UPPER(email) = ?";
