...
public class UserQuery {
	...
	public static final String GET_EMAIL_BY_INVOICE_NUMBER = "SELECT email FROM user_account usr INNER JOIN order_details ord ON usr.guid = ord.user_account_fk WHERE ord.invoice_number = ?";
